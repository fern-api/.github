...
* **SDKs** - Automatically generates production-ready SDKs that respect the idioms of each language. We support TypeScript, Python, Go, Java, Ruby, C# & PHP, with Swift & Rust coming soon. Every generated SDK contains strong types, inlined docs, and intuitive error handling.
...
Fern generates SDKs so you can focus on building the API. Engineering teams ship SDKs faster while developer experience teams can focus on what matters most.
